...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v4_2\\developer\\sdks\\gecko_sdk_suite\\v2.7\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 0 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL gp_combo_mg21_v670"':
        sys.exit(0)
    print (" ")
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\..\\..\\SiliconLabs\\SimplicityStudio\\v4_2\\developer\\sdks\\gecko_sdk_suite\\v2.7\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 0 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL gp_combo_mg21_v670"'.replace("\t", "\\t")
