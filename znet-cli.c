...
void emAfPluginSlotManagerCliBootloadSlot(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSlotManagerBootSlotCommandArguments[] = {
  "The slot ID to boot",
  NULL
};
#endif
...
void emAfPluginSlotManagerCliEraseSlot(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSlotManagerEraseSlotCommandArguments[] = {
  "The slot ID to erase",
  NULL
};
#endif


void emAfPluginSlotManagerCliPrintExternalFlashInfo(void);
void emAfPluginSlotManagerCliReadExtFlash(void);
#if defined(EMBER_COMMAND_INTEPRETER_HAS_DESCRIPTION_FIELD)
static const char * const pluginSlotManagerReadCommandArguments[] = {
  "Address to read",
...
void emAfPluginSlotManagerCliPrintSlotsInfo(void);
static EmberCommandEntry emberCommandPluginSlotManagerTable[] = {
  emberCommandEntryActionWithDetails("boot-slot", emAfPluginSlotManagerCliBootloadSlot, "w", "Boot the image in the specified slot ID.", pluginSlotManagerBootSlotCommandArguments),
  emberCommandEntryActionWithDetails("erase-slot", emAfPluginSlotManagerCliEraseSlot, "w", "Erase the specified slot ID.", pluginSlotManagerEraseSlotCommandArguments),
  emberCommandEntryActionWithDetails("ext-flash-info", emAfPluginSlotManagerCliPrintExternalFlashInfo, "", "Print external flash information.", NULL),
  emberCommandEntryActionWithDetails("read", emAfPluginSlotManagerCliReadExtFlash, "wu", "Read raw data from external flash.", pluginSlotManagerReadCommandArguments),
  emberCommandEntryActionWithDetails("slots-info", emAfPluginSlotManagerCliPrintSlotsInfo, "", "Print information for all available slots.", NULL),
  emberCommandEntryTerminator(),
};
...
static EmberCommandEntry emberCommandPluginTable[] = {
  ...
  emberCommandEntrySubMenu("slot-manager", emberCommandPluginSlotManagerTable, ""),
